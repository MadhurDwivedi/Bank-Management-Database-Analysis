...
![Background Image](https://github.com/MadhurDwivedi/BankIQ_PL-SQL_Enterprise_Banking_Analysis/blob/main/Background%20Image.png)
## 📌 Project Objective
...
## 🗂️ Dataset Used
- ✔️ Unlike traditional analytical projects, this project does not rely on an external dataset.
- ✔️ The dataset is created internally within the database using:
  - ✔️ Table creation (DDL)
  - ✔️ Manual data insertion (DML)
  - ✔️ All customer banking records such as Account Number, Name, Mobile Number, Aadhaar, PAN, and Address are stored and managed                 directly inside the database.
